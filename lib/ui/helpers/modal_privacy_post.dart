      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: TextCustom(text: 'Ai có thể bình luận?', fontWeight: FontWeight.w500 )
            ),
            
            const SizedBox(height: 15.0),
            const TextCustom(text: 'Chọn người có thể bình luận bài viết', fontSize: 16, color: Colors.grey, maxLines: 2),
            ...
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const TextCustom(text: 'Tất cả', fontSize: 17,)
                ],
              ),
            ),
            const SizedBox(height: 20.0),
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10.0),
                  const TextCustom(text: 'Người theo dõi', fontSize: 17,)
                ],
              ),
            ),
            const SizedBox(height: 20.0),
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10.0),
                  const TextCustom(text: 'Tắt bình luận', fontSize: 17,)
                ],
              ),
            ),
