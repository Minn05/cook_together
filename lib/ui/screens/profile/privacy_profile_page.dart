    ...
    return BlocListener<UserBloc, UserState>(
      listener: (context, state) {
        if (state is LoadingChangeAccount) {
          ...
          Navigator.pop(context);
          modalSuccess(context, 'Thay đổi quyền riêng tư thành công',
        ...
        body: SafeArea(
          child: ListView(
            ...
            children: [
                  ...
                  child: BlocBuilder<UserBloc, UserState>(
                    ...
                    builder: (_, state) => Row(
                      children: [
                        ...
                        const TextCustom(
                            text: 'Tài khoản cá nhân', fontSize: 17),
                        const Spacer(),
              ...
              const SizedBox(height: 10.0),
              const TextCustom(
                  text: 'Tương tác', fontSize: 16, fontWeight: FontWeight.w500),
              const SizedBox(height: 10.0),
              ItemProfile(
                  text: 'Bình luận',
              ...
              ItemProfile(
                  ...
                  onPressed: () {}),
              ItemProfile(
                  text: 'Tin nhắn', icon: Icons.send_rounded, onPressed: () {}),
              const Divider(),
              const SizedBox(height: 10.0),
              const TextCustom(
                  text: 'Kết nối', fontSize: 16, fontWeight: FontWeight.w500),
              const SizedBox(height: 10.0),
              ItemProfile(
