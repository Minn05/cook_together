...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget streamSearchUser() {
    return StreamBuilder<List<ResponseSearchByKeyWordItem>>(
...
class _ListUsers extends StatelessWidget {
  final List<ResponseSearchByKeyWordItem> listUser;
      ...
      itemBuilder: (context, i) {
        return InkWell(
          onTap: () {
            ...
            //       context,
            //       routeSlide(
            //           page: RecipeDetailPage(recipeId: listUser[i].uid)));
            // }
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => ProfileAnotherUserPage(
                  idUser: listUser[i].uid,
                ),
              ),
            );
          },
                      ...
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(
                                  Environment.baseUrl + listUser[i].avatar,
                                )),
                          ),
                        )
                      : CircleAvatar(
