...
import 'package:recipes/domain/models/response/response_post.dart';
import 'package:recipes/domain/models/response/response_post_by_user.dart';
import 'package:recipes/domain/models/response/response_post_profile.dart';
import 'package:recipes/domain/models/response/response_post_saved.dart';
...
class PostServices {
  ...
  Future<List<Recipe>> getAllPostHome() async {
    final token = await secureStorage.readToken();
