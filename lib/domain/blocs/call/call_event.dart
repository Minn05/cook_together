...
class OnCallVideoRTCEvent extends CallEvent {
  ...
  OnCallVideoRTCEvent(this.strOffer, this.strAnswer, this.candidateTemp,
      this.callId, this.receiId, this.offer);
}
...
class OnCallVideoRTCStateEvent extends CallEvent {
  ...
  OnCallVideoRTCStateEvent(this.strOffer, this.strAnswer, this.candidateTemp,
      this.callId, this.receiId, this.offer);
}
