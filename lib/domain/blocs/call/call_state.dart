...
class CallVideoRTCState extends CallState {
  ...
  const CallVideoRTCState(
      {required this.strOffer,
      required this.strAnswer,
      required this.candidateTemp,
      required this.callId,
      required this.receiId,
      required this.offer,
      required this.isCannel})
      : super(
            callerId: callId,
            candidate: candidateTemp,
            receiverId: receiId,
            sessionAnswer: strAnswer,
...
class CancelCallVideoState extends CallState {
  ...
  const CancelCallVideoState({required this.isCancel})
      : super(isDisabled: isCancel);
}
